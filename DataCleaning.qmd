...
data_anim <- joined_data |> 
  ...
  geom_point() +
  labs(y = "Income Share of The Middle 20%",
       subtitle = "{frame_time} ",
       x = "Life Expectancy(Years)",
       title = "Relationship Between Income Share of The Middle 20% and Life Expectancy for Countries Across Years") +
...
animate(data_anim, nframes = 61, fps = 2)
