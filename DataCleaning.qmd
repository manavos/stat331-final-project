...
**Life Expectancy Data** Here I will load and clean the life expectancy data for the project.I decided to remove all years with missing values, and decrease sample size to around 100 data points. In addition, I also created a seprate table of average life expectancy for each country per decade.
